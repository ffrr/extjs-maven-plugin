 ...
 *
 * Usage: http://dojotoolkit.org/reference-guide/dojox/json/schema.html
 * 
 * @author fk
 * @version 0.1
 * @date Aug 5, 2011
...
Ext.define('DanteFrontend.lib.ux.SchemaValidator', {
    singleton: true,
	...
	if(!result.valid)
		throw new TypeError(Ext.Array.map(result.errors, function(error){return "for property " + error.property + ': ' + error.message;}).join(", "));
    },
